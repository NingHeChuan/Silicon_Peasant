...
set rc [catch {
  ...
  add_files -quiet F:/Vivado/ZYBO_Project/02_HDMI_output_test/HDMI_output_test.runs/synth_1/top.dcp
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file top_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file top_timing_summary_routed.rpt -warn_on_violation  -rpx top_timing_summary_routed.rpx"
